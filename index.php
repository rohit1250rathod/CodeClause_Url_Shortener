...
<body>
  ...
  <div class="wrapper">
    <label for="" class="linkpath"><i class="fa-solid fa-link"></i>Enter Your Long URL to make a Short Url</label>
      ...
      if(mysqli_num_rows($sql2) > 0){;
        ?>
          <div class="statistics">
            ...
            ?>
            <span>Total Links: <span><?php echo end($res) ?></span></span>
          ...
          <?php
            while($row = mysqli_fetch_assoc($sql2)){
              ?>
                ...
                <li><a href="php/delete.php?id=<?php echo $row['shorten_url'] ?>"><i class="fa-solid fa-trash-can"></i></a></li>
              </div>
              <?php
            }
          ?>
  ...
  <div class="popup-box">
  <form action="#" autocomplete="off">
    <label><i class="fa-solid fa-wand-magic-sparkles"></i>Customize your Link or Save</label>
